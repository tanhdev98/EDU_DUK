                ...
                _createClass(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                (this.game = initDragDrop({
                                    elements: { container: t, areas: n, objs: a },
                                    callbacks: {
                                        end: r.endCallback,
                        ...
                        },
                        {
                            key: "getZoomRate",
                            value: function () {
                                if (!document.querySelector("html").classList.contains("noUI")) return { x: 1, y: 1 };
                        ...
                        },
                        {
                            ...
                            value: function () {
                                console.log("checkTotalComplete ".concat(this.TOTAL_COUNT, " : ").concat(this.TOTAL_COMPLETE_COUNT)), this.TOTAL_COUNT === this.TOTAL_COMPLETE_COUNT && (console.log("끝!"), this.QUIZ.toggleAnswerBtn());
                            },
                        },
                        {
                    ...
                    [
                        {
                            ...
                            value: function (e) {
                                ...
                                n && o ? (a.endCorrect(), window.$efSound.correct()) : (a.endWrong(), null);
                            },
                        },
                        { key: "movedOutCallback", value: function () { } },
                        {
                            key: "completeArea",
                            value: function (e) {
                                var t = e,
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                for (var n, a = t.element.children, o = 0, r = a.length; o < r; o++) if (((n = a[o]), e.element.className === n.className)) return !0;
                                return !1;
                            },
                        },
                    ]
