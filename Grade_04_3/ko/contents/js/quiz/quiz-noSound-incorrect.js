...
!function () {
    ...
    $ts.loadScriptFile("../ko/libs/js/dragdropCore.js"), $ts.loadScriptFile("../ko/contents/js/quiz/dragDrop-noSound-incorrect.js"), $ts.loadScriptFile("../ko/contents/js/quiz/dragLine.js"), window.$quiz = function (t) {
        return new i(t)
    }
}(), function () {
    function e(s) {
