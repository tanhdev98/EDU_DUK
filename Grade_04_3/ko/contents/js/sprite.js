    ...
    var y = {
            ...
            this.initSpriteListObj(h), 0 < L.spriteList.length ? L.spriteList.forEach(function (r, e) {
                ...
                if (a.style.backgroundImage = "url(" + r.spriteSheet + ")", a.style.width = r.width + "px", a.style.height = r.height + "px", a.setAttribute("data-idx", dataIdx), y.isChrome && (a.style.opacity = 0), y.spriteList[h].characterList.push(t), y.spriteList[h].sheetList.push(a), y.spriteList[h].thumbNailList.push(n), r.textBubble) {
                    ...
                    if (r.textBubble.top) {
                        ...
                        i.style.width = r.textBubble.width + "px", i.style.bottom = r.textBubble.bottom + "px", i.style.left = r.textBubble.left + "px", i.style.display = "none", i.style.textAlign = r.textBubble.textAlign, i.style.wordBreak = r.textBubble.wordBreak;
                    }
                ...
                a_wrap.addEventListener("click", function (e) {
                    ...
                    if (e.preventDefault(), y.currentSpriteId = h, y.originalSpriteList = L.spriteList, _this.classList.contains("waiting")) {
                        ...
                        vtaReset();
                        console.log('characterWrap - close');
                    }
                    else {
                        vtaReset();

                        console.log('characterWrap - open');
        ...
        Sound: function (e) {
            ...
            t.element = e.element, e.volume && (t.element.volume = e.volume), e.loop && (t.element.loop = e.loop), e.callBack && (t.callBack = e.callBack), t.endSound = function () {
                t.element.removeEventListener("ended", vtaReset()), e.callBack && e.callBack()
...
function vtaReset() {
    ...
    $('.characterWrap').addClass('speech');
    $('.charSpriteAni').css('background-position', 'unset');
    console.log('vtaReset');
}