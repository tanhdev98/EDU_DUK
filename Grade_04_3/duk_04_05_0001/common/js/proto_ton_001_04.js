...
$(document).on('click', '.learning-item > li', function () {
    ...
    $('.popBtn[data-popBtn="' + clickedPopbtn + '"]').attr('data-img', $(this).attr('data-img'));
...
function reLoad() {
    ...
    if (storedData.length > 0) {
        storedData.forEach(data => {
            ...
            let dataImg = $('.learning-list>li:nth-child(' + tabIdx + ') .learning-item>li:nth-child(' + liIndx + ')').attr('data-img');
            $('.popBtn[data-popBtn="' + popBtn + '"]').html(html);
            $('.popBtn[data-popBtn="' + popBtn + '"]').attr('data-img', dataImg);
